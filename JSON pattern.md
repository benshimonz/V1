...
|Mandatory| Name      | Type   | Description
|---------|-----------|--------| ------
| +       | qType     | string | "all"/"some"/"gt"/"ge"/"notall"/"none"/"eq"/"ne"/"range" <br> "lt" and "le" are not used. To avoid ambiguity - either _range_ [0 .. value] or _range_ [1 .. value] should be used
|         | qVal      | int    | mandatory if qType = "gt"/"ge"/"eq"/"ne". "ne" is satisfied only if > 0
