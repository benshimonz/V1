...
- P1 may appear below a 'split by _relprop_' which appears below a relationship. The relationship may be wrapped by an 'L'
- _relprop_ is a property of the relationship
...
- P2 may appear below a 'split by _relprop_' which appears below a relationship. The relationship may be wrapped by an 'L'
- _relprop_ is a property of the relationship
...
- P3 may appear below a 'split by _relprop_' which appears below a relationship. The relationship may be wrapped by an 'L'
...
- P4 may appear below a 'split by _relprop_' which appears below a relationship. The relationship may be wrapped by an 'L'
- _relprop_ is a property of the relationship
